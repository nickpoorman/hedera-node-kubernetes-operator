...
import (
	...
	scheme "github.com/nickpoorman/hedera-node-kubernetes-operator/client/clientset/versioned/scheme"
...
func newTenants(c *V1alpha1Client, namespace string) *tenants {
	return &tenants{
		client: c.RESTClient(),
		ns:     namespace,
	}
